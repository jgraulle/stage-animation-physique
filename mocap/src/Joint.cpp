...
Joint::Joint(string nomJoint, int nchannels, bool transJoint, float offset[3], string chtype[6], int id) {
    ...
    // Si l'id n'a pas �t� sp�cifi�, on en g�n�re
    if (id == -1)
...
void Joint::addEndSite(float endLength[3]) {
    ...
    // Indique la pr�sence du terminal
    endSite = true;
}
...
// DOES:   renvoie l'offset d�fini en dur dans le Bvh entre 2 joints
//////////////////////////////////////////////////
...
// DOES:   D�fini l'offset en dur dans le Bvh entre 2 joints
//////////////////////////////////////////////////
...
// DOES:   renvoie l'offset d�fini en dur dans le Bvh entre 2 joints dans le cas
...
// DOES:   D�fini l'offset en dur dans le Bvh entre 2 joints dans le cas
//			d'un joint terminal seulement
//////////////////////////////////////////////////
...
// DOES:   renvoie l'offset dans la frame du joint de la donn�e de position d'un des axe
//			En g�n�ral, X en premier (Offset=0), Y en deuxieme, Z en 3ieme
//////////////////////////////////////////////////
...
// DOES:   renvoie l'offset dans la frame du joint de la donn�e de rotation d'un des axe
//			En g�n�ral, Z en premier (Offset=0), X en deuxieme, Y en 3ieme
//////////////////////////////////////////////////
int Joint::getOffsetRotChannel(char axe) {

	// Enregistre le d�calage de 3 en offset si le joint � des champs de position (rare � part la racine)
	int debut=0;
	if (transJoint) {
		debut = 3;
	}
...
// DOES:   Indique sur le joint poss�de des attributs
//         de translation (en g�n�ral, seulement le root)
//////////////////////////////////////////////////
...
// DOES:   renvoie le type des channels sous forme de chaine de caract�re
//////////////////////////////////////////////////
